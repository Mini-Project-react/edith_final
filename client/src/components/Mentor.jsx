      ...
      <div className="container mx-auto max-w-[80%] flex flex-col space-y-4 justify-center items-center">
        ...
        <div className="bg-white w-full flex items-center p-2 rounded-xl shadow border">
          ...
          <div className="flex-grow p-3">
            <div className="font-semibold text-gray-700">{task.taskname} </div>
            <div className="font-semibold text-gray-500">
              {task.desc}
            </div>
            <div className="text-sm text-gray-500">{task.date.substring(0,10)}</div>
          </div>
          <div className="p-2">
                  ...
                  {showModal.Submissions.map((submit)=>(
                    <div className="grid grid-cols-1 space-y-2 divide-y-4 divide-y-reverse">
                      ...
                      <div className="flex  justify-between">
                        ...
                        <a href={'http://localhost:5000/uploads/'+submit.file} target="_blank" > {submit.file}</a>
